...
public class Profile implements Parcelable{
    ...
    private int preferred_level_id = -1 ;
    ...
    private String preferred_fee_range_max  ="";
    private String preferred_loan_required_name  ="";
    private int preferred_loan_required_id  = -1;
    private String preferred_loan_amount_needed_name  ="";
    private int preferred_loan_amount_needed_id  = -1;
   // private String yearly_exams[];
    ...
    public int getMother_tongue_id() {
        return mother_tongue_id;
    }

    public void setMother_tongue_id(int mother_tongue_id) {
    ...
    public int getCurrent_mode_id() {
        return current_mode_id;
    }

    public void setCurrent_mode_id(int current_mode_id) {
        this.current_mode_id = current_mode_id;
    }
    ...
    public int getCurrent_score_type_id() {
        return current_score_type_id;
    }

    public void setCurrent_score_type_id(int current_score_type_id) {
        this.current_score_type_id = current_score_type_id;
    }
    ...
    public int getPreferred_mode_id() {
        return preferred_mode_id;
    }

    public void setPreferred_mode_id(int preferred_mode_id) {
        this.preferred_mode_id = preferred_mode_id;
    }
    ...
    public int getPreferred_level_id() {
        return preferred_level_id;
    }

    public void setPreferred_level_id(int preferred_level_id) {
        this.preferred_level_id = preferred_level_id;
    }
    ...
    public String getPreferred_fee_range_max() {
        return preferred_fee_range_max;
    }

    public void setPreferred_fee_range_max(String preferred_fee_range_max) {
    ...
    public int getPreferred_loan_required_id() {
        return preferred_loan_required_id;
    }

    public void setPreferred_loan_required_id(int preferred_loan_required_id) {
        this.preferred_loan_required_id = preferred_loan_required_id;
    }
    ...
    public int getPreferred_loan_amount_needed_id() {
        return preferred_loan_amount_needed_id;
    }

    public void setPreferred_loan_amount_needed_id(int preferred_loan_amount_needed_id) {
        this.preferred_loan_amount_needed_id = preferred_loan_amount_needed_id;
    }
